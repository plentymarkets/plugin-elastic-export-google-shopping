...
# Elastic Export Google Shopping Plugin for plentymarkets 7

This is the elastic export Google Shopping plugin for plentymarkets 7 which extends the list of possible export formats. 
